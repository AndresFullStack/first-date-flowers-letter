...
import { motion, AnimatePresence } from "framer-motion"; // ← CORREGIDO
...
const TextCursor: React.FC<TextCursorProps> = ({
  ...
  return (
    <div ref={containerRef} className="w-full h-full relative z-50">
        ...
        <AnimatePresence>
          {trail.map((item) => (
            <motion.div
              ...
              className="absolute z-50 select-none whitespace-nowrap text-3xl"
